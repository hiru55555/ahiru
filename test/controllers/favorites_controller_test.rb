...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { food: @favorite.food, number: @favorite.number, song: @favorite.song } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { food: @favorite.food, number: @favorite.number, song: @favorite.song } }
